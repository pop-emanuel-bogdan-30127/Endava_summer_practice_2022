...
//    public void showIngredientOptions(Menu menu){
//        OrderService orderService = new OrderService();
//        orderService.enumIngredients(menu);
//    }
    ...
    public boolean completeStandardTransaction(Order order,Bank bank,int orderIndex) throws IOException {
        if (!isCard()) {
            ...
            bank.updateAccount("C:\\Users\\ux533fda8011 lot\\Desktop\\Endava_summer_practice\\" +
                    "Chapter1 User Story#2\\Repository\\Accounts.txt");
            addOrder("C:\\Users\\ux533fda8011 lot\\Desktop\\Endava_summer_practice\\Chapter1 User Story#2\\Repository\\Record.txt",
